...
```
Phase 1  →  Data Acquisition & Engineering  →  Master Panel (country-year)
...
gfip/
  ...
  src/
    ...
    pipeline/     # Master Panel assembly (Phase 1)
...
Phase 1 ingests from: FAO AQUASTAT, NASA GRACE/GRACE-FO, World Bank Open Data, UNDP HDR,
Fund for Peace FSI, UCDP, ACLED, UNODC, WHO/GHDx, UNHCR/IOM, UN DESA, CMIP6/WorldClim,
